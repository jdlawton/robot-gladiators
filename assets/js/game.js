...
/*var fight = function(enemy) {
    ...
    while(enemy.health > 0 && playerInfo.health > 0) {
        // ask if user wants to fight or skip using fightOrSkip function
        ...
        if (isPlayerTurn) {
            ...
            // remote enemy's health by subtracting the amount set in the playerInfo.attack variable
    ...
    for (var i = 0; i < enemyInfo.length; i++) {
        if (playerInfo.health > 0) {
            ...
            if (playerInfo.health > 0 && i < enemyInfo.length - 1) {
                //ask the user if they want to shop
...
var endGame = function() {
    ...
    if (playerInfo.health > 0) {
        ...
        else window.alert("You did not beat the high score...");
    }
    else {
...
// function for shopping between rounds
var shop = function() {
